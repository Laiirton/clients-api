    ...
    <div class="p-4 lg:p-6 flex-grow">
        <div class="mb-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">
                ...
                <a href="{{ route('clients.index') }}" class="inline-flex items-center justify-center gap-2 bg-gray-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-gray-700 rounded-md shadow transition focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 w-full sm:w-auto">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('clients.update', $client) }}" class="space-y-6">
                        ...
                        <div>
                                ...
                                <div class="relative w-full">
                                    <div class="flex flex-col sm:flex-row items-stretch w-full overflow-hidden rounded-md shadow-sm">
                                        ...
                                        <button type="button" 
                                            ...
                                            class="mt-2 sm:mt-0 sm:relative sm:-ml-px inline-flex items-center justify-center rounded-md sm:rounded-l-none sm:rounded-r-md border border-gray-300 dark:border-zinc-700 bg-gray-50 dark:bg-zinc-700 px-4 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-zinc-600 transition">
                            ...
                            <button type="submit" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-blue-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-700 rounded-md shadow transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
